...
The app saves scanned EuroPark/autoparkki access URLs and license plates locally on the phone, then sends the same web request that the legacy autoparkki QR page expects.
...
Open this `native-android/` directory in Android Studio, then run:
